...
ATpsPlayer::ATpsPlayer()
{
	...
	gun->SetRelativeLocation(FVector(-5.05, 4.75, -3.21)); //(X=-5.053648,Y=4.754128,Z=-3.211116)
	...
	sniper->SetRelativeLocation(FVector(-5.05, 4.75, -3.21)); //(X=-16.829862,Y=38.262773,Z=137.831087)
